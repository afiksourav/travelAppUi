...
import 'package:mobile_list_animaiton/widgets/frosted_widget.dart';

class TravelDestinationDetailsPage extends StatefulWidget {
  final String destinationName;
  const TravelDestinationDetailsPage({required this.destinationName, super.key});

  @override
  State<TravelDestinationDetailsPage> createState() => _TravelDestinationDetailsPageState();
}

class _TravelDestinationDetailsPageState extends State<TravelDestinationDetailsPage> {
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      ...
                                      style: TextStyle(fontSize: 35, fontWeight: FontWeight.bold, color: Colors.white, height: 1.1, letterSpacing: -1),
                                    ),
                                  ),
          ...
          Positioned(
            ...
            child: GestureDetector(
              ...
              child: TweenAnimationBuilder(
                tween: Tween<double>(begin: _scrollPosition >= 50 ? 1 : 0, end: _scrollPosition >= 50 ? 0 : 1),
                duration: Duration(milliseconds: 500),
                //    curve: _scrollPosition >= 160 ? Curves.easeOut : Curves.easeOut,
        ...
        children: [
          ...
          Column(
            ...
            children: [
              Text(
                title,
                style: TextStyle(fontSize: 18, color: TravelColors.lightBrown, fontWeight: FontWeight.w600),
              ),
              Text(
                value,
                style: TextStyle(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                ...
                                style: TextStyle(
                                  fontSize: 20,
                                  color: i == _selectedIndex ? TravelColors.orange : TravelColors.lightBrown,
                                  fontWeight: FontWeight.bold,
                                ),
                              ),
                              const SizedBox(height: 5),
